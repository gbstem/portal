 ...
 * copy it here (admin's README, "Adding a New Semester").
 */
export type Course = {
  id: string
  track: CourseTrack
 ...
 * switched every dropdown to spring - and course names already written to
 * Firestore were then offered by no form at all.
 */
