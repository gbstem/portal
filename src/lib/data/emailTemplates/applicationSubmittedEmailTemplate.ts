...
// Source: src/lib/emails/templates/applicationSubmittedEmailTemplate.mjml
  ...
  <head>
    ...
    @media only screen and (max-width:479px) {
      ...
      ><p style="margin: 20px 0"></p>
          ...
          Thanks for applying to be a gbSTEM instructor! We'll be reviewing
          applications on a rolling basis, and we'll email you if you are
          selected for an interview. You can also check the status of your
